...
const BASE_ENV = { GOOGLE_CLIENT_ID: "x", GOOGLE_CLIENT_SECRET: "x", GOOGLE_REFRESH_TOKEN: "x" };

const SCENARIOS = [
  { label: "default", env: {} },
  { label: "narrow (drive)", env: { GD_TOOLS: "drive" } },
  { label: "typical (drive,docs,sheets)", env: { GD_TOOLS: "drive,docs,sheets" } },
];
